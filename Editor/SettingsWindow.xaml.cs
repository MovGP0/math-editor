    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void okButton_Click(object sender, RoutedEventArgs e)
        {
            ConfigManager.SetConfigurationValues(new Dictionary<KeyName, string>() {
                {KeyName.DefaultMode, ((ComboBoxItem)editorModeCombo.SelectedItem).Tag.ToString()},
                {KeyName.DefaultFont, ((ComboBoxItem)equationFontCombo.SelectedItem).Tag.ToString()}
            });
            this.Close();
        }
