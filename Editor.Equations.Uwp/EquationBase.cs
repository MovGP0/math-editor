...
namespace Editor
{
    public abstract class EquationBase : UIElement
    {
        ...
        public virtual bool ConsumeKey(VirtualKey key) { return false; }
        ...
        public virtual bool Select(VirtualKey key) { return false; }
        ...
        public virtual void SetCursorOnKeyUpDown(VirtualKey key, Point point) { }
